...
const Toolbar = ({ editor, onToggleSidebar, onToggleDark, onToggleLock, onExportTXT, isLocked }) => {
  if (!editor) {
  ...
  return (
    <div className="flex items-center px-2 py-1.5 bg-[var(--bg-primary)] border-b border-[var(--border)] overflow-x-auto custom-scrollbar gap-0.5">
      ...
      <ToolbarButton onClick={onToggleLock} title={isLocked ? "Unlock Note" : "Lock Note"}>
        {isLocked ? (
